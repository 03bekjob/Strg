...
public:
	...
	int m_CurCol;
	_variant_t m_vNULL;
	_RecordsetPtr ptrRs1,ptrRs2,ptrRs3,ptrRs4,ptrRsCmb1;
	_CommandPtr ptrCmd1,ptrCmd2,ptrCmd3,ptrCmd4,ptrCmdCmb1;
...
protected:
	...
	static void InitDataGrid1F(CDatagrid1& pG,_RecordsetPtr& rs);
