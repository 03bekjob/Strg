...
#include "resource.h"
//#include "c:\documents and settings\bek\my documents\visual studio 2005\projects\strg\ordstrg\datagrid1.h"
//#include "c:\documents and settings\bek\my documents\visual studio 2005\projects\strg\ordstrg\datagrid1.h"
...
public:
	...
	int m_CurCol;
	_variant_t m_vNULL;
	_RecordsetPtr ptrRs1,ptrRs2,ptrRs3;
	_CommandPtr ptrCmd1,ptrCmd2,ptrCmd3;
...
public:
	...
	void ClickDatagrid3();
public:
	void ButtonClickDatagrid3(short ColIndex);
};
